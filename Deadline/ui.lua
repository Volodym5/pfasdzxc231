...
VisualsTab:CreateSection("Toggle")
...
VisualsTab:CreateSection("Transparency")
...
MiscTab:CreateToggle({
    Name = "No Explosion Effect", CurrentValue = false,
...
MiscTab:CreateToggle({
    ...
    Callback     = function(v)
        ...
        if v then state.startNV() else state.stopNV() end
    end,
})
