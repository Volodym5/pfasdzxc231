...
function PhantomUI:CreateWindow(config)
    ...
    function Window:AddTab(label, icon)
        ...
        function Tab:AddToggle(cfg)
            ...
            Utility.Stroke(Track, Value and T.BorderAccent or T.Border, 1, 0.3)
            ...
            if Value then Utility.GlowEffect(Thumb, T.Accent, 12) end
        ...
        function Tab:AddTextbox(cfg)
            ...
            Utility.Stroke(Box, T.BorderAccent, 1, 0.5)
            ...
            Box.Focused:Connect(function()
                ...
                Utility.Stroke(Box, T.Accent, 1, 0)
            end)
