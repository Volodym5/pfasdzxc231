...
function NexusLib:CreateWindow(opts)
    ...
    function Window:AddTab(name, icon)
        ...
        function Tab:AddButton(opts)
            ...
            -- Arrow icon on right
            local arrow = NewLabel(btn, "›", UDim2.new(0,20,1,0), T.Accent, "Arrow", Enum.Font.GothamBold, 18)
        ...
        function Tab:AddDropdown(opts)
            ...
            local arrow = NewLabel(trigger, "▾", UDim2.new(0,20,1,0), T.TextMuted, "Arr", Enum.Font.GothamBold, 12)
